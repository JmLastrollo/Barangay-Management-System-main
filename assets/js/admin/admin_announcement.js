...
function checkUrlParams() {
    ...
    if (success === 'added') showToast('Announcement posted successfully!', 'success');
    else if (success === 'updated') showToast('Changes saved successfully!', 'success');
    else if (archived === 'true') showToast('Announcement moved to archive.', 'success'); 
...
function updateTableDisplay() {
    ...
    filteredData.forEach(item => {
        ...
        // --- DITO ANG PAGBABAGO SA DESIGN NG ACTION BUTTONS ---
        const row = `
            <tr>
                <td>
                    <img src="${imgSrc}" 
