...
<body>
                ...
                <div class="modal-body">
                    <form action="../../backend/announcement_update.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 text-center">
                             ...
                             <div class="mt-2">
                                 <label for="edit-photo" class="btn btn-sm btn-outline-primary"><i class="bi bi-camera"></i> Change Photo</label>
            ...
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-2 rounded overflow-hidden border shadow-sm" style="height: 250px; background: #eee;">
                        <iframe id="v_map_frame" width="100%" height="100%" style="border:0;" loading="lazy"></iframe>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            showToast(
                "<?= htmlspecialchars($_SESSION['toast_announcement']['msg']) ?>", 
                "<?= htmlspecialchars($_SESSION['toast_announcement']['type'] ?? 'success') ?>"
            );
        });
    </script>
