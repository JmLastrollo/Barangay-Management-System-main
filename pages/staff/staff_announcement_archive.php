    ...
    <div class="content">
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
            <div class="d-flex align-items-center gap-2">
                ...
                <input type="month" id="monthFilter" class="form-control" style="width: auto; border-radius: 20px;">
                <select id="sortSelect" class="form-select" style="width: auto; border-radius: 20px;">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (typeof showToast === 'function') {
            ...
            showArchiveToast("<?= htmlspecialchars($_SESSION['toast_announcement']['msg']) ?>", "<?= htmlspecialchars($_SESSION['toast_announcement']['type'] ?? 'success') ?>");
        }
    });
</script>
<?php unset($_SESSION['toast_announcement']); ?>
<?php endif; ?>
