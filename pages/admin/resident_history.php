...
<head>
    ...
    <title>BMS - Resident History</title>
...
<body>
    ...
    <div id="main-content">
        ...
        <div class="header">
            <h1 class="header-title">RESIDENT <span class="green">HISTORY</span></h1>
        ...
        <div class="content">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                <div class="search-box">
                    <input type="text" id="residentLogSearch" placeholder="Search activity or resident..." class="form-control shadow-sm" style="border-radius: 20px; width: 300px;">
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody id="residentLogsTable">
                                <?php if(empty($logs)): ?>
                                    <tr class="no-logs"><td colspan="3" class="text-center py-4 text-muted">No activity logs found for residents.</td></tr>
                                <?php else: ?>
                                    <?php foreach ($logs as $log): ?>
                                    <tr class="log-row" data-date="<?= date("Y-m-d", strtotime($log['timestamp'])) ?>">
                                        <td class="ps-4 fw-bold">
                                            <div class="d-flex align-items-center">
                                                <div class="bg-success-subtle text-success rounded-circle d-flex align-items-center justify-content-center fw-bold me-3" style="width: 35px; height: 35px;">
                                                    <?= strtoupper(substr($log['first_name'], 0, 1)) ?>
                                                </div>
                                                <?= htmlspecialchars($log['first_name'] . ' ' . $log['last_name']) ?>
                                            </div>
                                        </td>
                                        <td class="text-muted small"><?= htmlspecialchars($log['action']) ?></td>
                                        <td>
    ...
    <script src="../../assets/js/admin/resident_history.js"></script>
</body>
</html>