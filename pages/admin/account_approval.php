...
try {
    // Gumamit na tayo ng 'created_at' dahil yun ang nasa database mo
    $stmt = $conn->prepare("
    ...
    // Ibinalik sa empty array para hindi mag-crash ang page
    $pendingUsers = [];
}
?>
...
<head>
    ...
    <title>BMS - Account Approval</title>
    ...
    <style>
        /* Optional: CSS para sa danger toast kung wala sa toast.css mo */
        .toast.danger {
