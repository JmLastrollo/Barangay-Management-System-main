...
// 2. Fetch Archived Announcements (PHP Side)
try {
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
        ...
        <div class="modal-body text-center pb-4">
            ...
            <h4 class="fw-bold mb-2">Restore Announcement?</h4>
            <p class="text-muted">This announcement will be visible to the public again.</p>
            
            <form action="../../backend/announcement_update.php" method="POST" class="mt-4">
                <input type="hidden" name="id" id="r_id">
                <input type="hidden" name="status" value="active"> 
                <input type="hidden" name="from_page" value="archive">
                <div class="d-flex justify-content-center gap-2">
                    <button type="button" class="btn btn-light px-4" data-bs-dismiss="modal">Cancel</button>
                    <button class="btn btn-success px-4" type="submit">Yes, Restore</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center pb-4">
                ...
                <p class="text-muted">This action cannot be undone. Are you sure you want to <b>permanently delete</b> this record?</p>
                
                <form action="../../backend/announcement_delete.php" method="POST" class="mt-4">
...
<script>
    const initialData = <?= json_encode($announcements) ?>;
</script>
