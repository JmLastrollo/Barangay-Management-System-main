...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_request'])) {
    ...
    // Logic para sa Payment Status
    $pay_status = 'Unpaid';
    if ($price == 0) {
        $pay_status = 'Free';
        $pay_method = 'Cash'; // Force cash if free
    } elseif ($pay_method === 'Online') {
        $pay_status = 'For Verification';
    }
    ...
    try {
        ...
        // 1. INSERT ISSUANCE (Fixed: Added payment_status)
        $sqlIssuance = "INSERT INTO document_issuances 
                        (resident_id, request_control_no, document_type, purpose, amount, status, payment_method, payment_status, requested_at) 
                        VALUES (:rid, :ctrl_no, :dtype, :purp, :price, 'Pending', :pmethod, :pstat, NOW())";
            ...
            if (isset($_FILES['proof_file']) && $_FILES['proof_file']['error'] === UPLOAD_ERR_OK) {
                ...
                if (in_array($fileExt, $allowed)) {
                    ...
                    if (move_uploaded_file($fileTmpPath, $uploadDir . $newFileName)) {
                        ...
                        $sqlUpdate = "UPDATE document_issuances SET proof_of_payment = :img WHERE issuance_id = :iid";
                        $stmtUpdate = $conn->prepare($sqlUpdate);
                        $stmtUpdate->execute([':img' => $newFileName, ':iid' => $issuance_id]);
                    }
                }
            }
        } 
        ...
        $conn->rollBack();
        // Specific error display for debugging
        $_SESSION['toast'] = ['msg' => 'Database Error: ' . $e->getMessage(), 'type' => 'error'];
    } catch (Exception $e) {
        $conn->rollBack();
    ...
    <div id="main-content">
        ...
        <div class="content pb-4">
            ...
            <div class="alert alert-info border-0 shadow-sm d-flex align-items-center mb-4">
                ...
                <div class="small"><strong>Note:</strong> Waiting time depends on admin approval. Please check your history for updates.</div>
            </div>
                ...
                <div class="col-lg-8 col-md-10">
                    <div class="card border-0 shadow-sm rounded-4">
                        <div class="card-body p-3 p-md-5">
                            ...
                            <h4 class="fw-bold text-dark mb-4 text-center text-md-start">
                                <i class="bi bi-file-earmark-plus-fill text-primary me-2"></i>New Request Form
                            </h4>
                            
                            <?php if(isset($_SESSION['toast'])): ?>
                                <div class="alert alert-<?=$_SESSION['toast']['type'] == 'success' ? 'success' : 'danger'?> alert-dismissible fade show" role="alert">
                                    <?= $_SESSION['toast']['msg'] ?>
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3 mb-md-4 p-3 bg-light rounded border text-center" id="price_display_box" style="display:none;">
                                ...
                                <div class="mb-3 mb-md-4">
                                    ...
                                    <textarea name="purpose" class="form-control" rows="3" placeholder="State your reason..." required></textarea>
                                </div>

                                <div class="mb-3 mb-md-4" id="payment_section">
                                ...
                                <div id="online_payment_section" class="mb-4 p-3 p-md-4 bg-light rounded border" style="display: none;">
                                    ...
                                    <div class="d-flex flex-column flex-md-row align-items-center gap-4 mb-4">
                                        <div class="bg-white p-2 rounded border shadow-sm">
                                            <img src="../../assets/img/gcash_qr.jpg" alt="GCash QR Code" class="img-fluid" style="width: 150px; height: 150px; object-fit: contain;">
                                        </div>
                                        ...
                                        <div class="text-center text-md-start">
                                            ...
                                            <div>
                                                ...
                                                <button type="button" class="btn btn-sm btn-outline-secondary ms-2 rounded-pill" onclick="navigator.clipboard.writeText('09123456789')">
                                    ...
                                    <div class="form-text small">Ensure the reference number is visible.</div>
                                </div>

                                <div class="d-grid gap-2 mt-4 pt-2">
                                    <button type="submit" name="submit_request" class="btn btn-primary btn-lg rounded-pill fw-bold shadow-sm">Submit Request</button>
